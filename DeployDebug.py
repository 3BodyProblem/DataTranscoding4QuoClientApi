...
if __name__ == '__main__':
	try:
                copyfile( "DataTranscoding4QuoClientApi\Debug\DataTranscoding4QuoClientApi.dll", "D:\ServiceManager\srvunit\DataTranscoding4QuoClientApi\DataTranscoding4QuoClientApi.dll" )
